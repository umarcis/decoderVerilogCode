...
HD_PWD='C:/Users/Umar/Decoder/Decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lights_of_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lights_of_decoder.tcl
