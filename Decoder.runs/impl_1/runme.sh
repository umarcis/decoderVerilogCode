...
HD_PWD='C:/Users/Umar/Decoder/Decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lights_of_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lights_of_decoder.tcl -notrace
